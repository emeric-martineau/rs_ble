        ...
        if self.is_dev_up != is_dev_up {
            if is_dev_up {
                match  self.sub_state {
                    ...
                    HciSubState::IsDevUpEventMask => println!("TODO"),
                    HciSubState::IsDevUpLeEventMask => println!("TODO"),
                    HciSubState::IsDevUpReadLocalVersion => println!("TODO"),
                    HciSubState::IsDevUpWriteLeHostSupported => println!("TODO"),
                    HciSubState::IsDevUpReadLeHostSupported => println!("TODO"),
                    HciSubState::IsDevUpReadBdAddr => println!("TODO"),
                }
            }
        } else {
            // TODO
